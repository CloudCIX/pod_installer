...
def build(win):
    ...
    firewall_rules = [
        ...
        # g: PUBLIC to and from SUBNET BRIDGES: N/A
        ...
        # n: PUBLIC to and from SUBNET BRIDGES: N/A
        # PUBLIC to HA: Inbound Block From Public to HA: Since default rules are blocked, no need this
        # HA to PUBLIC: Outbound Block From HA to Public: Since default rules are blocked, no need this
        # PUBLIC to PRIVATE: N/A
        # PRIVATE to PUBLIC: N/A
        ...
        # e: Allow all
        {'order': 3161, 'version': '6', 'iiface': '', 'oiface': 'any', 'protocol': 'any', 'action': 'accept', 'log': True, 'source': [config_data['ipv6_link_cpe'], f'{mgmt_ipv6_3hex}::10:0:2', f'{mgmt_ipv6_3hex}::10:0:1', 'fe80::/10'], 'destination': ['any'], 'port': []},
