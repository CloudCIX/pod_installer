...
def build(win):
    ...
    # sort ipaddresses
    oob_ip = f'100.64.{config_data["pod_number"]}.253'
    configured, error = net.build(
        host='localhost',
    ...
    firewall_rules = [
        ...
        {'order': 3123, 'version': '6', 'iiface': 'mgmt0', 'oiface': '', 'protocol': 'icmp', 'action': 'accept', 'log': True, 'source': [config_data['ipv6_link_pe'], config_data['pat_ipv6_subnet'], f'{mgmt_ipv6_3hex}:d0c6::/64', f'{mgmt_ipv6_3hex}::/64', 'fe80::/10'], 'destination': [config_data['ipv6_link_cpe'], f'{mgmt_ipv6_3hex}::10:0:1', f'{mgmt_ipv6_3hex}::10:0:3', 'ff02::/8', 'fe80::/10'], 'port': []},
