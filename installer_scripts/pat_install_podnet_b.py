...
def build(win):
    ...
    firewall_rules = [
        ...
        {'order': 3126, 'version': '6', 'iiface': 'mgmt0', 'oiface': '', 'protocol': 'tcp', 'action': 'accept','log': True, 'source': [robot_ipv6, robotworker_ipv6, pod_appliance], 'destination': [mgmt_ipv6_b], 'port': ['22']},
