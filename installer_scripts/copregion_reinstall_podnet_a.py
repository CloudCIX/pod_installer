...
def build(win):
    ...
    firewall_rules = [
        ...
        {'order': 3135, 'version': '4', 'iiface': 'any', 'oiface': '!=mgmt0', 'protocol': 'any', 'action': 'accept', 'log': False, 'source': ['any'], 'destination': ['any'], 'port': []},
        {'order': 3136, 'version': '4', 'iiface': 'any', 'oiface': '!=oob0', 'protocol': 'any', 'action': 'accept', 'log': False, 'source': ['any'], 'destination': ['any'], 'port': []},
